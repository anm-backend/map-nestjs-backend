...
export declare class TeacherController {
    ...
    registerTeacher(image: Express.Multer.File, createTeacherDto: CreateTeacherDto): Promise<import("../../utils/sendToken").SendToken>;
    loginTeacher(loginTeacher: {
        email: string;
        password: string;
    }): Promise<import("../../utils/sendToken").SendToken>;
    logoutTeacher(): void;
